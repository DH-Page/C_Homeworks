// adott egy tomb amiben a felhokarcolok merete van abrazolva, 
//szamitsuk ki a szomszedos felhokarcolok magassag kulombsegenek az osszeget
//legyen a tombben levo szam a 2^1024-en számjegyei
#include <stdio.h>
#include <stdlib.h> // abs miatt kell
#include <math.h> //pow miatt kell de vegul nem hasznaltam

int skyscraper(int t[], int size){
    int sum = 0;
